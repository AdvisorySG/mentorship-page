      ...
      >
        ...
        {testimonialData.map((el, i) => {
          return (
            ...
            >
              <div className="left">
                <div className={styles.para}>{el.mentor_testimonial}</div>
                <div className={styles.subText}>{el.mentor}</div>
              </div>
              <br />
              <div className="right">
                <div className={styles.para}>{el.mentee_testimonial}</div>
                <div className={styles.subText}>{el.mentee}</div>
              </div>
            </div>
          );
        })}
