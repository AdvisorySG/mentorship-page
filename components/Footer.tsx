    ...
    >
      <div className="w-screen max-w-screen-lg mx-auto grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 justify-items-center pt-16 px-16">
        ...
        >
          ...
          <p className="text-neutral-300 text-center sm:text-left md:text-center lg:text-left">
      ...
      <div className="w-screen max-w-screen-lg mx-auto grid grid-cols-1 sm:grid-cols-2 px-16 py-8">
