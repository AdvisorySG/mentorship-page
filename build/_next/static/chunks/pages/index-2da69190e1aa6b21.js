(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [405],
  {
    ...
    2888: function (e, s, r) {
                  ...
                  children: [
                    ...
                    (0, i.jsx)(S.ZP, {
                      ...
                      children: (0, i.jsx)(z.Z, {
                        ...
                        href: "#aboutus",
                        onClick: l,
                        children: (0, i.jsx)(k.Z, { primary: "About Us" }),
                      }),
                    }),
                    (0, i.jsx)(S.ZP, {
                      disablePadding: !0,
                      children: (0, i.jsx)(z.Z, {
                        ...
                        href: "#partners",
                        onClick: l,
                        children: (0, i.jsx)(k.Z, { primary: "Partners" }),
                      }),
                    }),
                    (0, i.jsx)(S.ZP, {
                      disablePadding: !0,
                      children: (0, i.jsx)(z.Z, {
                        ...
                        href: "#mentors",
                        onClick: l,
                        children: (0, i.jsx)(k.Z, { primary: "Mentors" }),
                      }),
                    }),
                    (0, i.jsx)(S.ZP, {
                      disablePadding: !0,
                ...
                children: (0, i.jsxs)(C.Z, {
                  children: [
                    (0, i.jsx)(f.Z, {
                      ...
                      children: (0, i.jsx)(M.Z, { style: { color: "black" } }),
                    }),
                    (0, i.jsx)("img", {
                      className: "nav-logo",
                      src: "/advisory-logo.png",
                      alt: "Advisory",
                      style: { alignSelf: "center" },
                    }),
                    (0, i.jsx)("a", {
                      className: "nav-back-to-main-site",
                      href: "https://advisory.sg",
      ...
      var A = function () {
                    ...
                    children: [
                      ...
                      (0, i.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, i.jsx)("p", {
                            children:
                              "Do take note that matching will commence on a rolling basis from 5 June onwards, and mentors that have been matched will no longer be displayed on the website thereafter.",
                          }),
                        ],
                      }),
                    ],
        ...
        Y = r(7918),
        J = function (e) {
          var s = e.displayResult,
            r = e.isShowReadMore,
            n = s.displayName,
            t = s.displayIndustries,
            l = s.displayRole,
            o = s.displayOrganisation,
            d = s.displayCourseOfStudy,
            c = s.displayFullBio,
            u = s.displayShortBio,
            h = s.displaySchool,
            p = s.industryColors,
            m = s.thumbnailImageUrl,
            f = (0, a.useState)(!r),
            x = f[0],
            y = f[1];
          return (0, i.jsxs)("div", {
              ...
              (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, i.jsxs)("ul", {
                    ...
                    children: [
                      (0, i.jsx)("li", {
                        className: "sui-result__industries",
                        children: t.map(function (e) {
                          return (0,
                          i.jsx)(Y.Z, { style: { backgroundColor: p.get(e), fontSize: "0.8rem", fontWeight: 500, marginRight: 10, marginBottom: 7 }, label: e });
                        }),
                      }),
                      (l || o) &&
                        (0, i.jsxs)("li", {
                        ...
                        (0, i.jsxs)("li", {
                          children: [
                            (0, i.jsx)("span", {
                              ...
                              style: { fontSize: 14 },
                              dangerouslySetInnerHTML: { __html: x ? c : u },
                            }),
                            r &&
                              (0, i.jsx)("a", {
      ...
      var ei = function (e) {
          var s = e.displayResult,
            r = s.displayName,
            n = s.displayOrganisation,
            t = s.displayRole,
            l = s.thumbnailImageUrl,
            o = (0, a.useState)(!1),
            d = o[0],
            c = o[1],
            u = function () {
              window.history.pushState({}, ""), c(!0);
            },
            h = function () {
              window.history.back();
            };
          return (
            ...
            (0, i.jsxs)($.Z, {
              className: "sui-result",
              style: { maxWidth: "165px", padding: "0px" },
              children: [
                (0, i.jsxs)(X.Z, {
                  onClick: u,
                  style: {
        ...
        ea = function (e, s) {
          ...
          return r.trim() === s.trim()
            ...
            : 0 === l.indexOf(n)
            ? e.replace(a, "") + "..."
            : o.indexOf(t) + t.length === o.length
            ? "..." + e.replace(i, "")
            : "..." + e.replace(i, "").replace(a, "") + "...";
        },
        en = function (e, s) {
          if (!e) return s;
          var r = (0, q.s9)(e, { wordwrap: !1 });
          return s.replace(r, e);
        },
        et = [T.Z, L.Z, W.Z, O.Z, H.Z, B.Z, F.Z, E.Z, G.Z, Q.Z, U.Z, V.Z].map(
          function (e) {
            return e[200];
          }
        ),
        ...
        eo = function (e) {
          var s = e.result,
            ...
            d = s.role,
            c = s.school,
            u = s.thumbnail_image_url,
            h = l && l.raw ? en(l.snippet, l.raw) : null,
            p = u && u.raw ? u.raw : null,
            m = t && Array.isArray(t.raw) ? t.raw : [];
          m.forEach(function (e) {
            el.has(e) || el.set(e, et[el.size % et.length]);
          });
          var f = d && d.raw ? en(d.snippet, d.raw) : null,
            x = o && o.raw ? en(o.snippet, o.raw) : null,
            y = a && a.raw ? en(a.snippet, a.raw) : null,
            g = c && c.raw ? en(c.snippet, c.raw) : null,
            j = n && n.raw ? ea(n.snippet, n.raw) : null,
            v = n && n.raw ? en(n.snippet, n.raw) : null,
            w = {
              displayCourseOfStudy: y,
              displayFullBio: v,
              displayIndustries: m,
              displayName: h,
              displayOrganisation: x,
              displayRole: f,
              displaySchool: g,
              displayShortBio: j,
              industryColors: el,
          ...
          return r
            ? (0, i.jsx)(J, { displayResult: w, isShowReadMore: !0 })
            : (0, i.jsx)(ei, { displayResult: w });
        };
      r(873);
      var ed = function () {
        var e = (0, x.Z)("(max-width: 800px)"),
          s = (0, a.useState)(!1),
          r = s[0],
          w = s[1],
          _ = [
          ...
          S = {
            ...
            apiConnector: new n.Z({
              engineName: "mentorship-page",
              endpointBase:
                "https://advisorysg.ent.ap-southeast-1.aws.found.io",
            ...
            initialState: { sort: [{ field: "", direction: "asc" }] },
            searchQuery: {
              result_fields: {
                course_of_study: { raw: {}, snippet: { size: 100 } },
                full_bio: { raw: {}, snippet: { size: 200, fallback: !0 } },
                full_image_url: { raw: {} },
                industries: { raw: {} },
              ...
              filters: [
                { type: "all", field: "wave_id", values: [_[Z].waveId] },
              ],
              ...
              children: [
                (0, i.jsx)("p", {
                  ...
                  children: (0, i.jsx)("small", {
                    children:
                      "The privacy and safety of our mentors is of utmost priority to Advisory. Any attempt to approach or contact our mentors outside of the parameters of the Advisory Mentorship Programme—whilst claiming affiliation to Advisory, or misrepresenting a relationship to Advisory—will be treated as misrepresentation, even fraudulent misrepresentation, as considered under the Misrepresentation Act. Advisory will take legal action against any individuals or organisations who attempt to deceive, harass, or otherwise request dishonest assistance from our mentors.",
                  }),
                }),
                (0, i.jsx)("div", {
                  className: "results",
                  ...
                  children: (0, i.jsx)(l.Z, {
                    ...
                    children: (0, i.jsx)("div", {
                      ...
                      children: (0, i.jsx)(t.Z, {
                          ...
                          children: [
                            ...
                            (0, i.jsx)(j.Z, {
                              ...
                              children: _.map(function (e) {
                                var s = e.waveName;
                                return (0, i.jsx)(v.Z, { label: s });
                              }),
                            }),
                          ],
                        }),
                        bodyContent: (0, i.jsx)(d.Z, {
                          resultView: function (e) {
                            var s = e.result;
                            return (0, i.jsx)(eo, { result: s, isListView: r });
                          },
                        }),
                        sideContent: (0, i.jsxs)("div", {
                          children: [
                            (0, i.jsx)(c.Z, {
                              label: "Sort by",
                              sortOptions: [
                        ...
                        bodyHeader: (0, i.jsxs)(a.Fragment, {
                          children: [
                            (0, i.jsx)(h.Z, {}),
                            (0, i.jsxs)("div", {
  ...
  function (e) {
    e.O(0, [649, 821, 774, 888, 179], function () {
      return e((e.s = 8312));
    }),
      (_N_E = e.O());
  },
